...
const COLUMN_WIDTHS = ["12rem", "9rem", "9rem", "6rem", "4.5rem", "7rem", "6.5rem", "6.5rem", "13rem", "8rem"];
...
export default async function AdminListingsPage({
  ...
  const [categories, allLocations] = await Promise.all([listAllCategoriesForAdmin(), listAllLocationsForAdmin()]);
  const states = allLocations.filter((l) => l.kind === "state");
